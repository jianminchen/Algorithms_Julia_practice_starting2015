...
class Solution
{
     ...
     * isWord, prefixNeighbor. 
     * @isWord - the word is in the original strings
     * @prefixNeighbor   - any string in the orginal strings 
     */
    internal class TrieWithPrefixNeighbor
    {
            ...
            string neighbour)
        {
            ...
            string updatedNeighbor = isWord && IsPrefix(prefixNeighbor, word)? prefixNeighbor : neighbour;
        ...
        private static bool IsPrefix(string prefix, string word)
        {
            ...
            return substring.CompareTo(prefix) == 0; 
        }
    ...
    static long Process(string[] dict)
    {
        ...
        //foreach (var group in groupped)
        {
            ...
            var sortedStrings = dict.OrderBy(x => x.Length);
    ...
    */
    ...
    static void RunSampleTestcase3()
    {
        string[] dictionary = new string[] { "A", "ABC" };
        var points = Process(dictionary);

        Console.WriteLine(points);
    }

    static void RunSampleTestcase4()
    {
        string[] dictionary = new string[] { "A", "B","AE" };
        var points = Process(dictionary);
