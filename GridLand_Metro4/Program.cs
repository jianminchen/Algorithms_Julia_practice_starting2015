...
namespace GridlandMetro
{
    class Program
    {
        ...
        */
         ...
         * 10:00 - 10:56
         * Principle: 
         * Do not write complicate code
         * So, Julia decided to rewrite
         * Make the loop very clear
         * Find the distinct row no, 
         * For each row no, 
         * Find count - how many in the array
         * Go to iterate on those one by one
         * 
         * Score 25 out of 25
         * 
         * Julia, congratulations! 
         * 
         * Summary: 3:00pm - 10:58pm 
         * 8 hours of work. 
         * 
         */
